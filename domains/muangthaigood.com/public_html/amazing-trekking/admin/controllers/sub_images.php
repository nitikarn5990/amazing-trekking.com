    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="da-panel collapsible">
                <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-<?php echo ($sub_images->GetPrimary() != '') ? 'application-edit' : 'add' ?>"></i> <?php echo ($sub_images->GetPrimary() != '') ? 'แก้ไข' : 'เพิ่ม' ?> ภาพข้อความ <?=$txt_type?></span> </div>
                        ...
                        <div class="da-form-inline">
                            ...
                            <div class="da-form-row">
                                ...
                                <div class="da-form-item large" id="filecopy"> <span class="formNote"><strong>Alt tag</strong> </span>
                                    ...
                                    <label class="da-form-label"> <span class="required">*</span>ขนาดรูปภาพแนะนำ <?=$_GET['position']==0 ? '633 x 112':'292 x 116'?></label>
...
?>
    <div class="row-fluid">
        <div class="span12">
            ...
            ?>
            <div class="da-panel collapsible">
                <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-grid"></i> รูปภาพข้อความ <?=$txt_type?> ทั้งหมด </span> </div>
                ...
                <div class="da-panel-content da-table-container">
                    <table id="da-ex-datatable-sort" class="da-table" sort="0" order="asc" width="1000">
                        ...
                        <tbody>
                            <?php 
                            $sql = "SELECT * FROM " . $sub_images->getTbl() . " WHERE name = '".$_GET['type']."'";
                            ...
                            while ($row = $db->FetchArray($query)) {
                                ...
                                <tr>
                                    <td class="center" width="15"><?php echo $row['id']; ?></td>
                       	    	     <td class="center" width=""><?php echo $_count == 0 ? 'ซ้าย':'ขวา'; ?></td>
