...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<?= ADDRESS ?>dist/slippry.min.js"></script>
                    ...
                    <ul id="demo1" style="list-style:none; position:0; margin:0; width:100%;">
                        ...
                        if ($numRow1 > 0) {
                            while ($row1 = $db->FetchArray($query1)) {
                                ?>
                                <li><a href="#slide<?= $row1['id'] ?>"><img src="<?php echo ADDRESS_SLIDES . $slides_file->getDataDescLastID("file_name", "slides_id = " . $row1['id']) ?>" /></a></li>
            ...
            <div id="content">
                ...
                <p style="text-align: left; width:100%;">
                    ...
                    if ($numRow1 > 0) {
                        while ($row1 = $db->FetchArray($query1)) {
                            ?>
                            <a href="<?= ADDRESS ?>img/<?= $row1['image'] ?>" rel="lightbox[example]" title="<?= $row1['name'] ?>"><img src="<?= ADDRESS ?>img/<?= $row1['image'] ?>" alt="<?= $row1['alt_tag'] ?>" class="bordered" /></a>
